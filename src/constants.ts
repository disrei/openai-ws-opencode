...
export const RESPONSE_ID_CACHE_PATH_ENV = "OPENAI_WS_OPENCODE_RESPONSE_ID_CACHE_PATH"
export const VERBOSE_LOG_ENV = "OPENAI_WS_OPENCODE_VERBOSE_LOG"
export const VERBOSE_LOG_MAX_ROUNDS_ENV = "OPENAI_WS_OPENCODE_VERBOSE_LOG_MAX_ROUNDS"
...
export const INTERNAL_RESET_PREVIOUS_RESPONSE_HEADER = "x-openai-ws-opencode-reset-previous-response-id"
